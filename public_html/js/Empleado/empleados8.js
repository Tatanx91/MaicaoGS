...
function activarDessactivarEmpleado(id,estado){
		var estado_update = 1;
		var texto = "è¢ƒEsta seguro de activar empleado?";

		if(estado == "1"){
			estado_update = 0; 
			texto = "è¢ƒEsta seguro de desactivar empleado?";
		}
...
function eliminarEmpleado(id,event){
		...
		if(confirm('¬øDesea eliminar el empleado?')){
