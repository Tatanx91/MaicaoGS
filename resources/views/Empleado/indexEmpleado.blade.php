...
<div class="row" style="margin-bottom: 2% !important;">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header bg-primary" style="background-color:#F63521;">
...
{!! Html::script('js/Empleado/empleados7.js') !!}
...
<script type="text/javascript">
   ...
   function validarConv(IDEmpleado, IdHijo)
   {
    ...
    var IDEmpleado = {!! json_encode($IDEmpleado) !!};
      $.get($("#APP_URL").val()+"/empleado/validarConvenioVigente/"+IDEmpleado+"/"+IdHijo).done(function(data){
          if(data.success){
            if(IdHijo !== "0"){
