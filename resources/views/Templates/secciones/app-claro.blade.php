...
<div id="header">
    @include('Templates.secciones._header-claro')
    <style>
        .modal-dialog{
    ...
    <div id="head" class="navbar navbar-inverse navbar-fixed-top" style="z-index:4; background-color:#F63521 !important; border-color: #295c93;margin-bottom: 5px !important;">
      <div id="loader">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
              <a class="navbar-brand" style="color: #FFFFFF; font-family: sans-serif !important" href="{{ url('/inicio/menuClaro') }}">Claro Colombia</a>
        ...
        <a href="{{ url('/logoutClaro') }}" title="Cerrar Sesion" style="color: #FFFFFF;float: right;">
            Cerrar Sesion
        </a>   
    </div>
